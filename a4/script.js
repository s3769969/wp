...
//goes to synopsis section on page
...
function nameCheck()
{
  ...
  else
  {
    ...
    document.getElementById('cust-name').style.backgroundColor='hsla(360, 70%, 85%, 1)';
    return false;
  }
}
...
function mobileCheck()
{
  ...
  else
  {
    ...
    document.getElementById('cust-mobile').style.backgroundColor='hsla(360, 70%, 85%, 1)';
    return false;
  }
}
...
function cardNoCheck()
{
  ...
  else
  {
    ...
    document.getElementById('cust-card').style.backgroundColor='hsla(360, 70%, 85%, 1)';
    return false;
  }
}
...
function expiryCheck()
{
  ...
  }else
  {
    ...
    document.getElementById('cust-expiry').style.backgroundColor='hsla(360, 70%, 85%, 1)';
    return false;
  }
}
